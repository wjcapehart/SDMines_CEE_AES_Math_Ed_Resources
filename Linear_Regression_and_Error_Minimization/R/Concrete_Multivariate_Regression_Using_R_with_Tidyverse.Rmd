...
Tidyverse uses what is sometimes called the "grammar of graphics" method
...
ggplot(data = concrete) +     # invoke graphics environment using a given dataframe
  ...
  xlab("28-dy Compressive Strength (MPa)") + # NEW : Custom Axis Label note use of superscripts from above
...
ggplot(data = concrete) +     # invoke graphics environment using a given dataframe
  ...
  xlab(expression("Cement Amount (kg m" ^3* ")")) + # NEW : Custom Axis Label note use of superscripts from above
